...
The general inverse problem is characterized by at least one of the following two complications:
 ...
 - The relationship between `data` and `model parameters` is non-linear?
