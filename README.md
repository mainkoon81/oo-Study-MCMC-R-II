...
MC ultimately concerns `θ`. However, IMC ultimately concerns `Adjusted Data_x`. As an adaptive procedure, by controlling model parameter `θ` sampling, IMC makes the corresponding data sampling follows some desired distribution ? we need.   
